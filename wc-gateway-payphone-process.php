...
class WC_Gateway_PayPhone_Process {
    ...
    // fee de payphone
        ...
        // AGREGAR fee de Payphone by DCV 
        $totalAmount = $order->get_total() + ($feePayphone / 100 * $order->get_total());
        $totalAmount = (round($totalAmount, 2) * 100);
        // FIN AGREGAR fee  
        ...
        // AGREGAR fee de Payphone by DCV 
        $subtotal = $request_params->AmountWithTax + ($feePayphone / 100 * $request_params->AmountWithTax);
        $subtotal = (round($subtotal, 2) * 100);
        // FIN AGREGAR fee  
        ...
        // AGREGAR fee de Payphone by DCV 
        $subtotalNoTax = $request_params->AmountWithOutTax + ($feePayphone / 100 * $request_params->AmountWithOutTax);
        $subtotalNoTax = (round($subtotalNoTax, 2) * 100);
        // FIN AGREGAR fee  
